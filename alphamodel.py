...
savings = 10000 #float(input('Please enter your current savings: '))
age = 30 #int(input('please enter your age: '))
...
print("SIMULATED MORTGAGEMENT PAYMENTS --------------------------------")
print(df[simulated_mortgage_payment_column].tail(50).to_string())
...
print("CUMALATIVE MORTGAGE PAYMENTS --------------------------------")
print(df['cumulative_mortgage_payments'].tail(50).to_string())
...
print(accumulated_wealth_at_67)
transformed_wealth = accumulated_wealth_at_67/((1+0.03)**(67-age))
print(transformed_wealth)
...
#
##SO Graph
#df['shared_ownership_share'] = df['shared_ownership_share'].apply(lambda x: min(x, 100))
#
#plt.figure(figsize=(10, 6))
